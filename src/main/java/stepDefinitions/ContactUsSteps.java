...
public class ContactUsSteps extends DriverFactory {
	...
	public void i_access_webdriveruniversity_contact_us_form() throws IOException, InterruptedException {
	...
	public void i_enter_a_valid_email_address() throws Exception {
		contactuspage.enterEmailAddress("saytosomnath@gmail.com");
	}
	...
	public void the_information_should_successfully_be_submitted_via_the_contact_us_form() throws Exception {
		contactuspage.ConfirmContactUsSuccesfull();
	}
}
